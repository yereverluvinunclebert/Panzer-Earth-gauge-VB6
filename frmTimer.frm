...
Private Sub settingsTimer_Timer()
    ...
    PzEUnhide = fGetINISetting("Software\PzEarth", "unhide", PzESettingsFile)

    If PzEUnhide = "true" Then
        globeWidget.Hidden = False
        sPutINISetting "Software\PzEarth", "unhide", vbNullString, PzESettingsFile
    End If
