...
Private Sub mnuHelpHTM_Click()
    On Error GoTo mnuHelpHTM_Click_Error
        ...
        Else
            MsgBox ("The help file - pzEarth.html.html- is missing from the help folder.")
        End If
...
Private Sub mnuLockWidget_Click()
    ...
    If PzEPreventDragging = "1" Then
        ...
        panzerEarthPrefs.chkPreventDragging.Value = 0
    Else
        mnuLockWidget.Checked = True
        globeWidget.Locked = 1
        PzEPreventDragging = "1"
        panzerEarthPrefs.chkPreventDragging.Value = 1
    End If
